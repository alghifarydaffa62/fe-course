...
const Register = () => {
    ...
    return(
        <div className="flex w-full flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20">
            <div className="flex w-2/3 lg:w-1/3 flex-col items-center justify-center gap-10">
                <Image src='/images/general/logo.svg' alt="logo" width={180} height={180}/>
                <Image 
                    src='/images/illustrations/login.svg' 
                    alt="login" width={1024} height={1024}
            ...
            <Card>
                <CardBody className="p-8">
                    ...
                    {errors.root && (
                        <p className="mb-2 font-md text-danger">{errors?.root?.message}</p>
                    )}
